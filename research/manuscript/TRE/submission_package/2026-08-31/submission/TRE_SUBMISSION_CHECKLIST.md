...
| Item | Status | Notes |
|---|---|---|
| Journal scope fit | READY | Logistics / supply-chain risk and ML framing established. |
| Title | READY | TRE-focused title frozen in package. |
| Anonymized manuscript | READY | Author names, affiliations and repository identity blinded in the submission manuscript. |
| Abstract | READY | Final manuscript abstract prepared; verify live portal limit. |
| Keywords | READY | Six keywords. |
| Highlights | READY | Five concise bullets; verify portal character rules. |
| Figures | READY | Research figures are tracked; generated final-render hashes are in `SHA256SUMS.txt`. |
