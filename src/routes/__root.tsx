...
import lightCss from "../orca-light-theme.css?url";
...
function RootComponent() {
  ...
  return <QueryClientProvider client={queryClient}><OrcaProvider><SimulationProvider><AppShell><Outlet /></AppShell></SimulationProvider></OrcaProvider></QueryClientProvider>;
}
